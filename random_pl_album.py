...
class AlbumList:
    ...
    def _choose_random_album(self, current_album_name):
        ...
        if len(self._albums) < 1:
            ...
            for i in range(0,3):
                ...
                new_album_index = random.choice(list(range(0, len(self._albums) - 1)))
    ...
    def is_last_song_in_album(self, currentsong):
        ...
        if 'album' not in currentsong:
            ...
            return False
        if currentsong['album'] not in self._last_song_pos:
            return False
